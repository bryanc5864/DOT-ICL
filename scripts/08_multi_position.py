...
def run_multi_position(model_name="meta-llama/Llama-3.2-3B-Instruct", device="cuda:3", n_demos=5, n_test=10, output_dir="results/exp8"):
    ...
    # Dynamic test layers based on model depth (fractional positions)
...
if __name__ == "__main__":
    ...
    run_multi_position(model_name=args.model, device=args.device, n_test=args.n_test, output_dir=args.output_dir)
